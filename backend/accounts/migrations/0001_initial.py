    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be in format: '+639123456789' or '09123456789'", regex='^\\+?63\\d{10}$')])),
                ('address_line_1', models.CharField(blank=True, max_length=255)),
                ('address_line_2', models.CharField(blank=True, max_length=255)),
                ('city', models.CharField(blank=True, max_length=100)),
                ('province', models.CharField(blank=True, max_length=100)),
                ('postal_code', models.CharField(blank=True, max_length=10)),
                ('primary_occupation', models.CharField(blank=True, choices=[('freelancer', 'Freelancer'), ('micro_entrepreneur', 'Micro Entrepreneur'), ('jeepney_driver', 'Jeepney Driver'), ('market_vendor', 'Market Vendor'), ('online_seller', 'Online Seller'), ('delivery_rider', 'Delivery Rider'), ('domestic_worker', 'Domestic Worker'), ('construction_worker', 'Construction Worker'), ('street_vendor', 'Street Vendor'), ('tricycle_driver', 'Tricycle Driver'), ('other', 'Other')], max_length=50)),
                ('occupation_description', models.TextField(blank=True, help_text='Describe your work')),
                ('preferred_language', models.CharField(choices=[('en', 'English'), ('fil', 'Filipino')], default='en', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_monthly_income', models.DecimalField(blank=True, decimal_places=2, help_text='Estimated monthly income in PHP', max_digits=10, null=True)),
